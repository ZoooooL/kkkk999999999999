...
خارج ذلك: نطاق Live 1 `brodansh.de.com.eg` يبقى على `18.133.13.149`، ومتجر `zouljanaheen.com` يبقى كما هو. Live 2 على **`odoo.zouljanaheen.com`** (سجل A جديد إلى IP هيتزنر ثم `./scripts/ssl-init.sh` هناك فقط).
