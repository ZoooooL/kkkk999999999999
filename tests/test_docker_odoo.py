...
class DockerOdooTests(unittest.TestCase):
    def test_prod_reuses_live_enterprise_and_host_postgres(self):
        ...
        self.assertIn("18080", _read("nginx/brodansh.demo.conf"))
    ...
    def test_nginx_and_odoo_match_brodansh_url(self):
        ...
        self.assertIn("listen 18080", _read("nginx/brodansh.demo.conf"))
        self.assertIn("127.0.0.1:8069", _read("nginx/brodansh.demo.conf"))
